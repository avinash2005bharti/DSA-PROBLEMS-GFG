<h2><a href="https://www.geeksforgeeks.org/problems/set-all-odd-bits1900/1?page=1&category=Bit%20Magic&sortBy=difficulty">Set all odd bits</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number, the task is to set all odd bits of a number.<br>
